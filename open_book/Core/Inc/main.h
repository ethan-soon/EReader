...
#define EP_MISO_Pin GPIO_PIN_6
#define EP_MISO_GPIO_Port GPIOA
...
#define EP_BUSY_GPIO_Port GPIOC
#define EP_DC_Pin GPIO_PIN_7
#define EP_DC_GPIO_Port GPIOC
#define EP_PWR_Pin GPIO_PIN_8
#define EP_PWR_GPIO_Port GPIOA
#define EP_CS_Pin GPIO_PIN_9
